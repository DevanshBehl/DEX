...
export default function App() {
  return (
    <div className="relative min-h-screen bg-white text-neutral-900 overflow-hidden font-sans tracking-tight flex flex-col">
      ...
      <footer className="w-full relative bg-black pt-16 pb-8 px-6 lg:px-24 overflow-hidden mt-24">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-end justify-between border-b border-white/10 pb-12 mb-8 gap-8 md:gap-0">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm text-neutral-400 max-w-sm leading-relaxed font-medium">
              The premium non-custodial wallet for the modern web3 ecosystem. Reimagining the way you interact with the decentralized web.
            </p>
          </div>
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center justify-between text-xs font-medium text-neutral-500 gap-4 md:gap-0">
          <p>© {new Date().getFullYear()} Celestial Wallet. All rights reserved.</p>
